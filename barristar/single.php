...
$barristar_single_blog_widget = $barristar_single_blog_widget ? $barristar_single_blog_widget : 'sidebar-1';
// Theme Options
...
// Sidebar Position
if ( $barristar_sidebar_position === 'sidebar-right' && is_active_sidebar( $barristar_single_blog_widget ) ) {
	$barristar_layout_class = 'col-md-8';
	$barristar_sidebar_class = 'right-sidebar';
} elseif ( $barristar_sidebar_position === 'sidebar-left' && is_active_sidebar( $barristar_single_blog_widget ) ) {
	$barristar_layout_class = 'col-md-8 col-md-push-3';
	$barristar_sidebar_class = 'left-sidebar';
} else {
	$barristar_layout_class = 'col-md-12';
	$barristar_sidebar_class = 'hide-sidebar';
} ?>
<div class="blog-single-section section-padding <?php echo esc_attr( $barristar_content_padding .' '. $barristar_sidebar_class ); ?>" style="<?php echo esc_attr( $barristar_custom_padding ); ?>">
	<div class="container content-area ">
		<div class="row">
			<div class="single-content-wrap <?php echo esc_attr( $barristar_layout_class ); ?>">
		    ...
		    wp_reset_postdata(); ?>
				...
				<?php
				if ( $barristar_sidebar_position !== 'sidebar-hide' && is_active_sidebar( $barristar_single_blog_widget ) ) {
					get_sidebar(); // Sidebar
				} ?>
		</div>
	</div>
