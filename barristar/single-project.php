...
get_header();
	...
	// Theme Options
	$barristar_sidebar_position = cs_get_option( 'project_sidebar_position' );
	$barristar_single_comment = cs_get_option( 'project_comment_form' );
	$barristar_sidebar_position = $barristar_sidebar_position ? $barristar_sidebar_position : 'hide-sidebar';
	// Sidebar Position
	if ( $barristar_sidebar_position === 'sidebar-hide' ) {
		...
		$barristar_layout_class = 'col-md-8 col-md-push-4';
		$barristar_sidebar_class = 'left-sidebar';
	} else {
		$barristar_layout_class = 'col-md-8';
		$barristar_sidebar_class = 'right-sidebar';
	} ?>
<div class="project-single-section section-padding <?php echo esc_attr( $barristar_content_padding .' '. $barristar_sidebar_class ); ?>" style="<?php echo esc_attr( $barristar_custom_padding ); ?>">
